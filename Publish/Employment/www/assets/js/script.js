...
function HideExtraDiv(){
    ...
    document.getElementsByClassName("headerTag")[0].nextSibling.style.display = "none";
    
}

function WindowReSize(){
    // var div = document.getElementById("homepageSecionDiv");
    // if(div !== null) //=91 the footer
   ...
   function  closeNav() {
    $(".content_details").toggleClass("mainlll");
   } 
...
/* ======
   ...
   ====== */
    ...
    $(window).on('load', function() {
        ...
        counterNumber();
        preloaderLoad();
        console.log(document.getElementsByClassName("headerTag")[0].style.width);
        document.getElementsByClassName("headerTag")[0].style.width = (parseInt(document.getElementsByClassName("headerTag")[0].style.width) + 17) + 'px';
        console.log(document.getElementsByClassName("headerTag")[0].style.width);
...
function applyFilter(data, filter){
    return  data.lstResult.filter(obj =>Object.entries(filter).every(([prop, find]) => find.includes(obj[prop])) )
 }