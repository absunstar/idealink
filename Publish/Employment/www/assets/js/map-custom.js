      ...
      if(iconPath) {
        map.addMarker({
          ...
          lat: 51.665929,
            ...
            title: 'Tenby ',
            infoWindow: {
            content: '<img src="/assets/images/partners/m1.jpg" alt="m1.jpg"> <h4>General Ledger Accountant</h4> <p class="fz14">Posted 23 August by <span class="text-thm2">Wiggle CRC</span></p>'
          }
        });
        map.addMarker({
